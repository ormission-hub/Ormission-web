  ...
  return (
    <section className="relative py-3 sm:py-6 lg:py-8">
      <div className="container-main px-3 sm:px-6">
        {/* Floating Capsule Card (All 4 stats strictly on 1 single row on all devices) */}
        <div className="bg-surface rounded-2xl sm:rounded-3xl py-3 px-1 sm:py-6 sm:px-6 lg:py-8 border border-border/80 shadow-capsule transition-all duration-300">
